    ...
    sections: [
      {
        ...
        subsections: [
          ...
          },
          {
            id: "elective",
            title:
              "請於下列 4. 戶外活動／5. 海上活動／6. 航空活動中選取其中一項為主要考核項目；\n各進度性獎章的選項須相同。海童軍必須選海上活動，空童軍必須選航空活動。",
            elective: true,
            items: [
              item("d-a-4", "4. 戶外活動（選修項目）", [
                "a. 明瞭戶外活動安全指引及郊野守則",
                "b. 完成下列其中一項戶外活動：",
                "I. 參與一次追蹤符號應用之活動",
                "II. 參與一次公園定向活動",
              ...
              item("d-a-5", "5. 海上活動（選修項目）", [
                "a. 明瞭海上活動安全守則",
                "b. 通過本會之游泳測試",
              ]),
              item("d-a-6", "6. 航空活動（選修項目）", [
                "a. 能指出旅客在機場及航機內一般航空安全守則",
                "b. 完成下列其中一項：",
                "I. 參與一個與航空有關的戶外活動",
    ...
    sections: [
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            elective: true,
            items: [
              item("s-a-4", "4. 戶外活動（選修項目）", [
                "a. 完成童軍探索獎章戶外活動部分",
                "b. 考獲一個從未在過往獎章獲得，並與戶外活動有關之專科徽章",
                "c. 完成下列其中一項從未在過往獎章參與之戶外活動：",
                "I. 參與一次城市追蹤活動",
                "II. 參與一次使用密碼、旗號或相類似形式之通訊活動",
              ]),
              item("s-a-5", "5. 海上活動（選修項目）", [
                "a. 完成童軍探索獎章海上活動部分",
                "b. 考獲艇工章",
                "c. 於本會海上活動中心，參與一次童軍標準艇以外之海上活動",
              ]),
              item("s-a-6", "6. 航空活動（選修項目）", [
                "a. 完成童軍探索獎章航空活動部分",
                "b. 考獲初級航空活動章",
                "c. 完成下列其中一項：",
                "I. 明瞭風如何影響飛行活動",
    ...
    sections: [
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            elective: true,
            items: [
              item("a-a-4", "4. 戶外活動（選修項目）", [
                "a. 完成童軍標準獎章戶外活動部分",
                "b. 考獲以下其中兩個專科徽章",
                "I. 露營（技能組）、探險（技能組）、先鋒工程（技能組）及原野烹飪（技能組）",
              ]),
              item("a-a-5", "5. 海上活動（選修項目）", [
                "a. 完成童軍標準獎章海上活動部分",
                "b. 考獲水手章",
                "c. 考獲與海上活動有關之專科徽章",
              ]),
              item("a-a-6", "6. 航空活動（選修項目）", [
                "a. 完成童軍標準獎章航空活動部份",
                "b. 考獲中級航空活動章",
                "c. 認識簡單的航空氣象",
              ]),
    ...
    sections: [
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            elective: true,
            items: [
              item("c-a-4", "4. 戶外活動（選修項目）", [
                "a. 完成童軍高級獎章戶外活動部分",
                "b. 策劃和參與一個全日小隊戶外活動",
              ]),
              item("c-a-5", "5. 海上活動（選修項目）", [
                "a. 完成童軍高級獎章海上活動部分",
                "b. 策劃及參與一個不少於六小時之海上旅程",
              ]),
              item("c-a-6", "6. 航空活動（選修項目）", [
                "a. 完成童軍高級獎章航空活動部份",
                "b. 於自選航空活動項目內選擇其中兩項從未進行過之項目",
              ]),
            ],
          },
        ],
